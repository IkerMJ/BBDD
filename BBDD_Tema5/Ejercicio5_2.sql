...
SELECT COUNT(EMPLEADOS.CLAVE_EMPLEADO) FROM EMPLEADOS, DEPARTAMENTO WHERE EMPLEADOS.CLAVE_DPTO=DEPARTAMENTO.CLAVE_DPTO AND DEPARTAMENTO.NOMBRE='Contabilidad';				
--NO ESTA ACABADO!!! CUANDO SEPAMOS ACABARLO, VOLVEMOS A EL!!!
